-- Rollback 016: Revert price hardening

-- Remove the date range check constraint
ALTER TABLE price_override
    DROP CONSTRAINT IF EXISTS chk_price_override_dates;

-- Restore original resolve_price() without ORDER BY (from 015)
